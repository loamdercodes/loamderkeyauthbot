...
async def on_ready():
  ...
  while True:
      await bot.change_presence(status=discord.Status.dnd, activity=discord.Activity(type=discord.ActivityType.playing, name="Made by loamify"))



# // input your User ID & Seller key | I Added a Fake one so Please Replace it.

allowed_user_ids = 914574192580653116 # can include more than one
seller_key = "d3911cd7870ce078d2a4239ea1ce45bf"
...
bot.run("MTIxMzU3OTAwMDI3OTIwMzkxMA.Go8nha.5DXrQnXzyfgCpYDMHvQfaYURYrt0rvNHRN1kzc") # // replace with the actuall bot token.